...
${OBJECTDIR}/src/graphic/Image.o: src/graphic/Image.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphic/Image.o src/graphic/Image.cpp
...
${OBJECTDIR}/src/controls/Joysticks.o: src/controls/Joysticks.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/Joysticks.o src/controls/Joysticks.cpp

${OBJECTDIR}/src/controls/ControlsManager.o: src/controls/ControlsManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/ControlsManager.o src/controls/ControlsManager.cpp

${OBJECTDIR}/src/controls/JoystickHatButton.o: src/controls/JoystickHatButton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/JoystickHatButton.o src/controls/JoystickHatButton.cpp

${OBJECTDIR}/src/graphic/TileMap.o: src/graphic/TileMap.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/graphic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphic/TileMap.o src/graphic/TileMap.cpp

${OBJECTDIR}/src/graphic/Sprite.o: src/graphic/Sprite.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/graphic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphic/Sprite.o src/graphic/Sprite.cpp

${OBJECTDIR}/src/controls/JoystickAxisButton.o: src/controls/JoystickAxisButton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/JoystickAxisButton.o src/controls/JoystickAxisButton.cpp

${OBJECTDIR}/src/graphic/Tileset.o: src/graphic/Tileset.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/graphic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphic/Tileset.o src/graphic/Tileset.cpp

${OBJECTDIR}/src/controls/Button.o: src/controls/Button.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/Button.o src/controls/Button.cpp

${OBJECTDIR}/src/util/VecteurNorme.o: src/util/VecteurNorme.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/util
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/util/VecteurNorme.o src/util/VecteurNorme.cpp

${OBJECTDIR}/src/graphic/Text.o: src/graphic/Text.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/graphic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphic/Text.o src/graphic/Text.cpp

${OBJECTDIR}/src/ParticleType.o: src/ParticleType.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ParticleType.o src/ParticleType.cpp

${OBJECTDIR}/src/controls/MouseButton.o: src/controls/MouseButton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/MouseButton.o src/controls/MouseButton.cpp

${OBJECTDIR}/src/controls/JoystickAxis.o: src/controls/JoystickAxis.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/JoystickAxis.o src/controls/JoystickAxis.cpp

${OBJECTDIR}/src/controls/KeyboardKey.o: src/controls/KeyboardKey.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/KeyboardKey.o src/controls/KeyboardKey.cpp

${OBJECTDIR}/src/util/Vecteur.o: src/util/Vecteur.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/util
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/util/Vecteur.o src/util/Vecteur.cpp
...
${OBJECTDIR}/src/controls/JoystickButton.o: src/controls/JoystickButton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/JoystickButton.o src/controls/JoystickButton.cpp

${OBJECTDIR}/src/ParticleEngine.o: src/ParticleEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ParticleEngine.o src/ParticleEngine.cpp

${OBJECTDIR}/src/util/GLutils.o: src/util/GLutils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/util
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/util/GLutils.o src/util/GLutils.cpp

${OBJECTDIR}/src/controls/Axis.o: src/controls/Axis.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/Axis.o src/controls/Axis.cpp

${OBJECTDIR}/src/Bonom.o: src/Bonom.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Bonom.o src/Bonom.cpp

${OBJECTDIR}/src/ObjectsManager.o: src/ObjectsManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ObjectsManager.o src/ObjectsManager.cpp

${OBJECTDIR}/src/graphic/Background.o: src/graphic/Background.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/graphic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphic/Background.o src/graphic/Background.cpp

${OBJECTDIR}/src/graphic/Screen.o: src/graphic/Screen.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/graphic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphic/Screen.o src/graphic/Screen.cpp

${OBJECTDIR}/src/graphic/Draw.o: src/graphic/Draw.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/graphic
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphic/Draw.o src/graphic/Draw.cpp

${OBJECTDIR}/src/AppContext.o: src/AppContext.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/AppContext.o src/AppContext.cpp

${OBJECTDIR}/src/controls/JoystickHatAxis.o: src/controls/JoystickHatAxis.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/controls
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/controls/JoystickHatAxis.o src/controls/JoystickHatAxis.cpp
